...
import "./Header.css"
import { Backdrop, ListItemIcon } from '@material-ui/core';
import ListAltIcon from "@material-ui/icons/ListAlt";
import { SpeedDial, SpeedDialAction } from '@material-ui/lab'
import { GoDashboard } from 'react-icons/go';
import { MdExitToApp, MdPersonPinCircle } from 'react-icons/md';
...
const UserOptions = ({ user }) => {
    ...
    const options = [
        ...
        { icon: <MdPersonPinCircle />, name: "Prodile", func: account },
        {
            icon: (
                <ShoppingCartIcon
